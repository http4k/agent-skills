...
AI coding skills that teach your agent how to work with the [http4k](https://http4k.org) Kotlin HTTP toolkit. Works with [Claude Code](https://claude.ai/code), [OpenCode](https://opencode.ai), and any agent that supports the Skills directory format.
